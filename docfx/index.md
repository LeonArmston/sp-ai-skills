...
<p class="hero-description">Community-contributed AI Skills for AI in SharePoint (Microsoft&nbsp;365&nbsp;Copilot). Drop a <code>SKILL.md</code> file into your site&rsquo;s <code>Agent&nbsp;Assets/Skills/</code> library and give your team repeatable, consistent AI-powered workflows &mdash; no&nbsp;code&nbsp;required.</p>
...
<div id="noResults" style="display:none;text-align:center;padding:48px 24px;color:#888">
